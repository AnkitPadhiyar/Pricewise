...
import { runCausalAnalysis } from '../services/api';
...
export default function Sidebar() {
  ...
  const handleRunAnalysis = async () => {
    try {
      ...
      await runCausalAnalysis();

      // Tell other components that a new analysis is available
      window.dispatchEvent(new Event('causal-analysis-complete'));

    } catch (error) {
      console.error('Causal analysis failed:', error);
      alert('Causal analysis failed. Please check the backend.');
    }
  };
  ...
  return (
    <aside className="sidebar">
      ...
      <div className="sidebar-logo-area">
        ...
        <div>
          <div className="sidebar-logo-text">Pricewise</div>
