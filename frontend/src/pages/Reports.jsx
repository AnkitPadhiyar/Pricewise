    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: 24, background: 'rgba(139,92,246,0.05)', border: '1px solid rgba(139,92,246,0.2)' }}>
        ...
        <p style={{ fontSize: 14, lineHeight: 1.8, color: 'var(--on-surface-var)', margin: 0 }}>
          The Pricewise Double Machine Learning analysis identified a statistically robust <strong style={{ color: 'var(--on-surface)' }}>Average Treatment Effect (ATE) of {causal.ate}</strong> per customer
